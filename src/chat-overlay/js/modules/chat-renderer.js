...
export class ChatRenderer {
    ...
    renderSuperChat(data, targetContainer, currentScrollArea) {
        this.eventRenderer.renderSuperChat(data, targetContainer, currentScrollArea);
    }

    renderMembershipEvent(data, targetContainer, currentScrollArea) {
        this.eventRenderer.renderMembershipEvent(data, targetContainer, currentScrollArea);
    }
    ...
    renderTwitchEvent(data) {
        this.eventRenderer.renderTwitchEvent(data);
    }
