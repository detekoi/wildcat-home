---
title: "Chat Overlay: New Home & Full Google Fonts Support"
date: 2026-04-01
description: "The Wildcat Chat Overlay has moved to wildcat.chat, and you can now pick any font from the Google Fonts catalog — over 1,900 options — including AI-generated themes that choose the perfect font for your vibe."
---
...
Just type a font name in the font search box and results appear instantly. If your font isn't in the default list, the overlay searches the full catalog and loads it on the fly.

![The chat overlay font search box with "playwr" typed in, showing matching results from Google Fonts](/assets/images/font-search.png)
...
To try it, use the **AI Theme Generator** in the settings panel and enter a game name, vibe, or aesthetic.
